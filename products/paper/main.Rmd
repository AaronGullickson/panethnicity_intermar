...
Figure \@ref(fig:latino-heat-map) shows comparable results for the nine largest Latino ethnic groups. Overall, the odds ratios in Figure \@ref(fig:latino-heat-map) are much lower than those in Figure \@ref(fig:asian-heat-map), reflecting the overall lower ethnic exogamy among Latino ethnic groups. The only case with no evidence of barriers to ethnic intermarriage was for Salvadorian and Guatemalans, where the estimated odds ratio is close to one.
