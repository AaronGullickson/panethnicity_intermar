...
PARAGRAPH JUSTIFYING THIS APPROACH RELATIVE TO OTHER APPROACHES
...
ggplot(diversity_pan, aes(x=group, y=diversity, fill=type))+
  ...
  labs(x=NULL, y="Probability two members do not share the same birthplace/language",
