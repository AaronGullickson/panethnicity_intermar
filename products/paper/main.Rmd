...
Each odds ratio is also unaffected by the degree of ethnoracial exogamy to other groups. For a given focal group, a high odds ratio of exogamy to one group does not mean that the odds ratio of exogamy to other groups must be low. Theoretically, for example, the odds ratio of exogamy to all outgroups could equal one, indicating no preference for endogamy and that partnering were concucted randomly with regard to race. In practice, odds ratios of exogamy are typically well below one, indicating some groups. Odds ratios are directly comparable to one another as measures of the social distance between groups.
