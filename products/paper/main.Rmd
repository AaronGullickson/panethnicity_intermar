...
> ==RELIC TO BE INTEGRATED SOMEWHERE ELSE== Specifically, panethnicity is a form of ethnogenesis in which smaller minority groups are "lumped" together into larger minority categories [@kibria_construction_1997; @wimmer_elementary_2008]. Such ethnogenesis can result from state efforts at consolidation, but can also arise from an increasing sense of solidarity and sense of linked fate among individuals in the lumped category [@wimmer_elementary_2008; @okamoto_panethnicity_2014a]. 
...
One advantage of the counterfactual marriage model is that it allows for the easy incorporation of a variety of quantitative and categorical variables. I utilize that feature to account for birthplace endogamy and language endogamy when estimating the likelihood of panethnic intermarriage, as well as age and educational differences between partners.
...
==PUT PARAGRAPH ELSEWHERE SO BETTER TRANSITION NEEDED==
