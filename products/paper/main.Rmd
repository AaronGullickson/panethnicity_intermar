...
Panethnic affinity may be driven by both cultural and structural factors [@lopez_panethnicity_1990]. Cultural factors such as shared language and religion may create affinity across ethnic or national boundaries. Structural factors such as economic and occupational similarity, spatial proximity (through either segregation or settlement patterns), and racialization (the tendency of natives to treat all members of the panethnic category as a monolithic racial group) may also play a role. The distinction between cultural factors and racializiation has been particularly important in differentiating the experiences of Asians and Latinos. Latinos share culture features such as language and religion that should promote panethnicity while Asians generally do not. On the other hand, racialization of Asians as a singular group tends to be stronger than for Latinos, who are more phenotypically diverse [@lopez_panethnicity_1990; @qian_latinos_2004]. 

Much of the initial work on panethnicity focused on the development of panethnic organizations and movements [@lopez_panethnicity_1990; @okamoto_theory_2003]. However, intermarriage was recognized by scholars of the field as an important area of research to capture the "on the ground" affinity between individuals from different ethnic groups but who were members of the same panethnic group [@lopez_panethnicity_1990, p. 219]. Several important studies were performed shortly after the turn of the century on this topic, using data from the 1980 and 1990 US Census [@qian_asian_2001; @rosenfeld_salience_2001; @qian_latinos_2004; @fu_how_2007a]. Both @qian_asian_2001 and @rosenfeld_salience_2001 explicitly compare the tendency toward panethnicity among Asians and Latinos and find a much stronger tendency toward panethnicty among Asians than Latinos. Both authors attribute this greater tendency to a higher degree of racialization among Asian populations (CHECK). @qian_asian_2001 and @qian_latinos_2004 use similar methods to examine pan-ethnicity among Asians and Latinos, respectively, and find substantial evidence of panethnic affinity, particularly among the native-born. [@qian_crossing_2012] use 2000 Census data to estimate panethnic affinities for Mexicans, Puerto Ricans, Chinese, and Filipinos. Their results generally show that similar levels of panethnicity across groups, particularly among the native-born, and that the likelihood of panethnicity is stronger than the likelihood of outmarriage to whites or other racial minorities, in contrast with earlier work. 
...
Although prior work has enriched our understanding of panethnicity in intermarriage, it has also suffered from well-acknowledged methodological difficulties. To begin, scholars must adjust for differences in group size in order to properly estimate the underlying affinity between groups in the marriage market, apart from issues of exposure [@blau_heterogeneity_1982a]. Some studies simply report what percentage of a group is outmarried to which other group, but the results from such studies are almost entirely driven by differences in group size [@min_patterns_2009]. 

Log-linear models have become the preferred tool to study assortative matting because they can address the issue of group size differences and were used by all of the work cited above. However, basic log-linear models will not address differences in spatial patterns among groups. Most individuals will find a partner within a local, rather than national, marriage market, and ethnoracial groups are not evenly distributed across the US. Without adjusting for these differences in geography, scholars will tend to underestimate the degree of ethnoracial exogamy [@harris_how_2005]. This is particularly important when studying panethnicity, because Latino and Asian ethnic groups have historically settled in different parts of the US (e.g. Cubans in Florida, Puerto Ricans in the Northeast, and Mexicans in the Southwest). Some of the prior work on panethnicity has attempted to address this issue. @fu_how_2007a includes Census division as a parameter in log-linear models to account for spatial dissimilarities in the distribution of groups, while @rosenfeld_salience_2001 estimates log-linear models separately within specific metropolitan areas. However, most of the prior work makes no adjustment for this important issue. 

An additional issue in all work on intermarriage is the difference between measuring the prevalence and incidence of intermarriage. Ideally, scholars wish to capture the incidence of intermarriage by examining recently formed marriages. However, most large-scale data has lacked information on marriage timing and so scholars have had to resort to restricting the age of spouses (e.g. limiting the analysis to marriages in which the wife is 20-34 years of age) in order to create semi-incidence measures with unknown biases. 
...
Related to this issue, the placement of South Asians within the panethnic category of Asian has been a matter of some debate among scholars. Individuals from the Indian subcontinent are treated as part of the panethnic Asian group by governmental agencies such as the Census Bureau, but research has shown that in everyday practice they are more generally treated as "ambiguous non-whites" [@kibria_not_1996; @morning_racial_2001; @schachter_finding_2014]. This may be in part because the "somatic norm image" of what an Asian in the US contexts looks like does not correspond to South Asian populations. However, most of he prior work on panethnic intermarriage has not included South Asian gorups, the lone exception being @qian_asian_2001 who included Asian Indians. They found that Asian Indians had the lowest rate of intermarriage with other Asian groups, who were all East or Southeast Asian. 
...
However, the actual situation for both birthplace and language endogamy is considerably more complex than either of these summaries imply becasue ethnic groups themselves are also diverse in terms of birthplace and language. For example, among adults recently married or single in the 2014-18 American Community Survey date detailed below, 66% of Japanese Americans spoke English as a primary language, while 41% of Filipino Americans spoke English as a primary language. For those Japanese Americans and Filipino Americans who both speak English, language endogamy will encourage panethnic intermarriage, while it will discourage ethnic endogamy with members of their own group who speak Japanese and Tagalog, respectively. Similarly, 31% of Mexican Americans in this sample spoke English as primary language, but only 13% of Dominican Americans. This contrast is further complicated however by the fact that among Mexicans and Dominicans who do not speak English as a primary language, they will almost certainly speak Spanish as their primary language.  
...
The odds of intermarriage with Blacks are uniformly low for all five E&SE Asian groups. The odds of intermarriage are also low for most Latino groups, with the exception of Dominicans and Puerto Ricans. For Dominicans, the odds of intermarriage with Blacks are almost identical to the odds of intermarriage with Whites. For Puerto Ricans, the odds of intermarriage with Blacks is the highest of any Latino ethnic group and is only slightly less likely than intermarriage with Whites. These differences almost certainly reflect the much higher prevalence of Afrodescent in Puerto Rican and Dominican populations and the racialization of members of these populations as black within the US. However, this pattern is not observed for other Latino populations with a higher prevalence of Afrodescent, such as Cubans and Colombians. 
