...
```{r metro-areas, fig.cap="Metropolitan statistical areas identifiable in the data by data source. The darkest shade indicates overlapping areas in the two data sources."}
