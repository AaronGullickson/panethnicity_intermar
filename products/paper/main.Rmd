...
==EXPAND/REWORK== The boundary approach to panethnicity utilized more broadly by many scholars would suggest that panethnicity is not simply a type of assimilation pattern, but rather a specific process of ethnoracial boundary expansion. This boundary expansion is not simply a function of assimilation and acculturation but can be deeply affected by these cross-cutting issues. 
