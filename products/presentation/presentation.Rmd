...
x %>%
  ...
  column_spec(2, background=c("grey","#e31a1c","#1f78b4",rep("#4daf4a",5),"#54278f",rep("#ff7f00",3))) %>%
  column_spec(3, background=c("#EAEBEE","grey","#a6cee3",rep("#b2df8a",5),"#6a51a3",rep("#fdbf6f",3))) %>%
  column_spec(4, background=c(rep("#EAEBEE",2),"grey",rep("#78c679",5),"#807dba",rep("#cc4c02",3))) %>%
  column_spec(5, background=c(rep("#EAEBEE",3),"grey",rep("#f7fcb9",4),"#9e9ac8",rep("#fe9929",3))) %>%
  column_spec(6, background=c(rep("#EAEBEE",4),"grey",rep("#f7fcb9",3),"#9e9ac8",rep("#fe9929",3))) %>%
  column_spec(7, background=c(rep("#EAEBEE",5),"grey",rep("#f7fcb9",2),"#9e9ac8",rep("#fe9929",3))) %>%
  column_spec(8, background=c(rep("#EAEBEE",6),"grey",rep("#f7fcb9",1),"#9e9ac8",rep("#fe9929",3))) %>%
  column_spec(9, background=c(rep("#EAEBEE",7),"grey","#9e9ac8",rep("#fe9929",3))) %>%
  column_spec(10, background=c(rep("#EAEBEE",8),"grey",rep("#bcbddc",3))) %>%
...
I use a "crossing" model to code the distance between four educational categories: less than high school, high school diploma, some college, but no four-year degree, Four-year college degree or more.

I also include variables for female educational hypergamy and hypogamy (ie. upward and dowward marriage).
...
#### Immigrant/Nativity Attraction

I include gender-specific variables that identify native/foreign-born couples regardless of country. 

---

## The Role of Birthplace and Language Endogamy

| H's Ethnicity  | W's Ethnicity  | H Birthplace | W Birthplace  | H Language | W Language | Endogamy                     | 
|----------------|----------------|--------------|---------------|------------|------------|------------------------------|
