...
main_findings:
  - 'After accounting for birthplace and language endogamy, E&SE Asian ethnic exogamy increased substantially over time while Latino ethnic exogamy remained relatively less likely.'
  - '![](big_splash.svg)'
main_picwidth: 90%
main_textsize: "90px"
...
alternates_acs %>%
  ...
  mutate(birthplace=factor(case_when(
    ...
    levels=c("USA","China","Hong Kong","Macau","Taiwan","Japan","Korea",
             ...
             "Cuba","Dominican Rep.","Puerto Rico","Other Place")),
  ...
  theme(legend.position = "bottom",
        ...
        strip.text= element_text(size=10, color="#EAEBEE"),
...
alternates_acs %>%
  ...
  coord_flip()+
  facet_wrap(~group, scales="free_y")+
  guides(fill = guide_legend(reverse = TRUE, ncol=5))+
  theme_bw()+
  theme(legend.position = "bottom",
...
ggplot(temp, aes(x=variable, y=exp(coef)))+
  ...
  labs(x=NULL, 
       ...
       color="Data source",
       title="Asian ethnic exogamy is much more likely than\nAsian interracial marriage, but Latino/White marriage\nis almost as common as Latino ethnic exogamy")+
...
coefs_pent %>%
  ...
  labs(y=NULL, 
       x="Odds ratio of ethnic intermarriage relative to ethnic endogamy",
       color="Data source",
       title="Ethnic exogamy among South Asians is also very high\nafter accounting for birthplace and language endogamy")+
  theme_bw()+
  theme(legend.position = "bottom",
        legend.text = element_text(size=12),
        legend.title = element_text(size=12),
...
4. The 1980 Census data only allow for the identification of Chinese, East Indian, Filipino, Japanese, Korean, and Vietnamese ethnicities among Asians and Mexican, Cuban, and Puerto Rican ethnicities among Latinos.
